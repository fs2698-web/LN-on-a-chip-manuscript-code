...
LN_chip_code/
- README.md
- data_demo/             # Example datasets (.rds for R, .xlsx for MATLAB)
- scripts_R/             # R scripts for scRNA-seq, GSEA, and CellChat
- scripts_MATLAB/        # MATLAB scripts for regression and donor clustering
- output_example/        # Representative figures generated by the scripts
